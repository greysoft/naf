...
{
    private HashedMap<String,String> hmap = new HashedMap<String,String>(3, 3);
    ...
    final public void testGrow()
    {
		...
		hmap.getBucketStats(true, 1);
		hmap.getBucketStats(false, 0);
		hmap.getBucketStats(true, 10);
    }
