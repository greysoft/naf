...
public class ConfigTest
{
	...
	public void testSynthesise() throws com.grey.base.ConfigException, java.io.IOException
	{
		...
		org.junit.Assert.assertEquals(68001, cfg.getPort(Config.RSVPORT_NAFMAN));
	...
	{
		String path = FileOps.getResourcePath("/naf.xml", ConfigTest.class);
		String dname = "testdispatcher1";

		Config cfg = Config.load(path);
		org.junit.Assert.assertEquals(21001, cfg.getPort(Config.RSVPORT_NAFMAN));
