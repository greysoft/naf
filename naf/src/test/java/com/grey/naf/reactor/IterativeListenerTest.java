	...
	implements com.grey.naf.EntityReaper
{
	...
	public void test() throws com.grey.base.GreyException, java.io.IOException
	{
		...
		IterativeListener lstnr = new IterativeListener("utest_IterativeListener", dsptch, fact, this, null, null, 0);
		TestServer srvr = (TestServer)lstnr.cnxhandler;
		...
		extends CM_Server
	{
			...
			throws com.grey.base.FaultException, java.io.IOException
		{
			...
			byte[] buf = ByteOps.encodeInt(req+1, rcvdata.ar_len);
