...
abstract public class ResourceData
{
	...
	final ByteChars setName(ByteChars src) {return rrname.set(src.ar_buf, src.ar_off, src.ar_len);}
	...
	public StringBuilder toString(StringBuilder sb)
	{
		...
		sb.append("RR=").append(Resolver.getQTYPE(rrType()));
	...
	{
		@Override
		public int rrType() {return Resolver.QTYPE_A;}
	...
	public static class RR_NS extends ResourceData
	{
		...
		@Override
		public int rrType() {return Resolver.QTYPE_NS;}
		@Override
		...
		RR_NS(RR_NS src, ByteChars qn) {
			super(src, qn);
			hostname = new ByteChars();
			if (src != null) src.hostname.copy(hostname);
		}
	...
	public static final class RR_SOA extends ResourceData
	{
		...
		@Override
		public int rrType() {return Resolver.QTYPE_SOA;}
		@Override
		...
		RR_SOA(RR_SOA src, ByteChars qn) {
			...
			rname = new ByteChars();
			if (src != null) {
				src.mname.copy(mname);
				src.rname.copy(rname);
				serial = src.serial;
				refresh = src.refresh;
				retry = src.retry;
				expire = src.expire;
	...
	public static final class RR_MX extends ResourceData
	{
		...
		@Override
		public int rrType() {return Resolver.QTYPE_MX;}
		@Override
	...
	public static final class RR_SRV extends ResourceData
	{
		...
		@Override
		public int rrType() {return Resolver.QTYPE_SRV;}
		@Override
		...
		RR_SRV(RR_SRV src, ByteChars qn) {
			super(src, qn);
			target = new ByteChars();
			if (src != null) {
				src.target.copy(target);
		...
		public String getDomain() {
			...
			if (pos == -1) return null;
			return name.toString(pos + 1, name.ar_len - pos - 1);
		}
	}
	...
	public static final class RR_AAAA extends ResourceData
	{
		...
		@Override
		public int rrType() {return Resolver.QTYPE_AAAA;}
	...
	public static final class RR_TXT extends ResourceData
	{
		...
		@Override
		public int rrType() {return Resolver.QTYPE_TXT;}
		@Override
	...
	public static final class RR_PTR extends RR_A {
		...
		@Override
		public int rrType() {return Resolver.QTYPE_PTR;}
	}
	...
	public static final class RR_CNAME extends RR_NS {
		...
		@Override
		public int rrType() {return Resolver.QTYPE_CNAME;}
	}
}
