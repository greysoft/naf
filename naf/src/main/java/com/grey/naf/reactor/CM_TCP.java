...
public abstract class CM_TCP extends CM_Stream
{
	...
	public final java.net.InetSocketAddress getLocalAddress() {return (java.net.InetSocketAddress)((java.nio.channels.SocketChannel)iochan).socket().getLocalSocketAddress();}
	public final java.net.InetSocketAddress getRemoteAddress() {return (java.net.InetSocketAddress)((java.nio.channels.SocketChannel)iochan).socket().getRemoteSocketAddress();}
