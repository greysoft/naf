...
public class Producer<T>
{
	...
	private Producer(Class<?> clss, Dispatcher d, Consumer cons, com.grey.logging.Logger log)
			throws com.grey.base.ConfigException, com.grey.base.FaultException, java.io.IOException
	{
		dsptch = d;
	...
	public void shutdown(boolean consume)
	{
		...
		try {
			...
			if (logger != null) logger.log(LEVEL.INFO, ex, true, "Error on Producer shutdown");
		}
	...
	public final void produce(T item, Dispatcher d) throws java.io.IOException
	{
		...
		if (alertspipe == null || d == alertspipe.dsptch) {
			...
			if (cnt == 0) alertspipe.signalConsumer();  //one signal is enough
		}
	}
	...
	private void notifyConsumer()
	{
		...
		try {
			...
			if (logger != null) logger.log(LEVEL.INFO, ex, true, "Consumer failed to handle Producer-indication - left "+availq.size()+"/"+ready);
		}
	}
