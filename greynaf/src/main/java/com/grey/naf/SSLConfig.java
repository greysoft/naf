...
public class SSLConfig
{
	...
	public static SSLConfig create(XmlConfig cfg, com.grey.naf.NAFConfig nafcfg, String peername, boolean client)
			throws java.io.IOException, java.security.GeneralSecurityException
	{
		return create(cfg, nafcfg, null, peername, client);
	}

	public static SSLConfig create(XmlConfig cfg, com.grey.naf.NAFConfig nafcfg, Def def, String peername, boolean client)
			throws java.io.IOException, java.security.GeneralSecurityException
	{
	...
	public SSLConfig(Def def) throws java.io.IOException, java.security.GeneralSecurityException
	{
		if (NO_RENEGOTIATION) {
		...
		if (isClient) {
			...
			if (def.clientAuth < -1 || def.clientAuth > 2) {
				throw new NAFConfigException("Illegal client-auth="+def.clientAuth);
			}
	...
	private static Def convert(XmlConfig cfg, com.grey.naf.NAFConfig nafcfg, Def def, String peername, boolean client)
	...
	static java.net.URL makeURL(String pthnam) {
		...
		try {
			...
			throw new NAFException("Failed to make URL from "+pthnam, ex);
		}
	}
